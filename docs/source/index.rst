...
Welcome to WildfireWiki's documentation!
========================================   
 ...
 * :ref:`Step 1:<DCR>` Compiling WRF-Fire for idealized cases
 * :ref:`Step 2:<idealized>` Running one of the test cases, namely “hill_simple” and “two_fires”, distributed with WRF-Fire.
 * :ref:`Step 3:<Ncview>` Visualizing the outputs of test cases using Ncview.
 * :ref:`Step 4:<tutorials>` After getting acquainted with WRF-Fire, you can follow the examples and commands tutorials to learn how to create different WRF-Fire models. You can also follow visualization tutorials for more visualization tools and options.
